  ...
  return <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        duration: 0.6
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4 bg-[sidebar-accent-foreground] bg-secondary">
          ...
          <div className="bg-card rounded-2xl shadow-luxury-lg border border-border overflow-hidden">
            ...
            <div className="p-6 md:p-8 bg-gradient-to-br from-primary/5 via-transparent to-accent/5">
              <div className="grid md:grid-cols-2 gap-6">
                {/* Monthly Income */}
                <motion.div key={`${selectedArea}-${selectedBedrooms}-monthly`} initial={{
                opacity: 0,
                scale: 0.95
              }} animate={{
                opacity: 1,
                ...
                {/* Annual Income */}
                <motion.div key={`${selectedArea}-${selectedBedrooms}-annual`} initial={{
                opacity: 0,
                scale: 0.95
              }} animate={{
                opacity: 1,
