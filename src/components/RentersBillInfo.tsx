    ...
    <section className="section-padding bg-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          className="max-w-4xl mx-auto bg-card border border-border overflow-hidden"
        >
          {/* Top bar accent */}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {challenges.map((item, index) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-primary font-heading font-bold text-sm uppercase tracking-wide mb-2">
                      {item.title}
                    </h3>
                    {item.description && (
